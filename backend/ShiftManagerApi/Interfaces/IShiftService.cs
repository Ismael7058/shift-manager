...
namespace ShiftManagerApi.Interfaces
{
  public interface IShiftService
  {
    ...
    Task<ShiftDto> Create(long clientId, CreateShiftDto createDto, bool isConfirm, long userId, string activeRole);
    Task Update(long shiftId, UpdateShiftDto updateDto);
    Task ChangeStatus(long? providerId, long? clientId, long shiftId, ShiftStatus status, long userId);
  }
}